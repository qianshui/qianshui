...
public class DaoFactory {
	...
	public IBaseHibernateDAO<Contact> getContactDao() {
		return new BaseHibernateDAO<Contact>(Contact.class);
	}

	public IBaseHibernateDAO<Subjecttype> getSubjecttypeDao() {
		return new BaseHibernateDAO<Subjecttype>(Subjecttype.class);
	}

	public IBaseHibernateDAO<Subject> getSubjectDao() {
		return new BaseHibernateDAO<Subject>(Subject.class);
	}
}
